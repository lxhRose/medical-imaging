...
class Report extends React.PureComponent<Props, any> {
    ...
    render() {
        const {selected, hover, xtzskData, openChild, grzskData, selectedRight} = this.state;
                        ...
                        <Col className="center-box">
                            <div className="scroll">
                                <div className="userInfo">
                                    <Row>
                                        <Col xxl={8} span={12}><span className="label">姓名：</span> {option.patientName}</Col>
                                        <Col xxl={8} span={12}><span className="label">性别：</span> {option.patientSex}</Col>
                                        <Col xxl={8} span={12}><span className="label">年龄：</span> {option.patientExamAge}</Col>
                                    {/* </Row>
                                    <Row> */}
                                        <Col xxl={8} span={12}><span className="label">设备类型：</span> {option.modalityType}</Col>
                                        <Col xxl={8} span={12}><span className="label">检查部位：</span> {option.examItemName}</Col>
                                        <Col xxl={8} span={12}><span className="label">检查日期：</span> {option.examTime}</Col>
                                    </Row>
                                </div>
